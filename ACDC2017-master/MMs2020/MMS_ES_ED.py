...
def process_patient(args):
    ...
    output_folder_data = '/home/laisong/MMs2020/MMS_ED_ES/data'
    output_folder_label = '/home/laisong/MMs2020/MMS_ED_ES/label'
    for name in ['ed','es']:
        sitk.WriteImage(images[name], os.path.join(output_folder_data, "%s_%s.nii.gz" % (patient_info[id]['code'], name)))
    for name in ['ed_seg','es_seg']:
        sitk.WriteImage(images[name], os.path.join(output_folder_label, "%s_%s.gt.nii.gz" % (patient_info[id]['code'], name)))
